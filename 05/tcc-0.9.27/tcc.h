...
struct SymAttr {
    ...
    unused      : 5;
#else
	// hopefully it didn't matter that these were bitfields
	unsigned char aligned,packed,weak,visibility,dllexport,dllimport;
#endif
};
...
#else
	// hopefully it didn't matter that these were bitfields
	unsigned char func_call,func_type,func_args;
#endif
};
